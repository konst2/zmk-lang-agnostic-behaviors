...
| zmk,behavior-ru-agnostic | Символ | Пытается найти символ в текущей раскладке системы и нажать соответствующую клавишу. Использовать для символов ` ?.,;:"/ `  которые присутствуют в разных раскладках, но на разных клавишах |
